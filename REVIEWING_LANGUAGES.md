...
**Short version**: Generate some puzzles, read and edit the config, check that the text is correct, and submit a PR with your changes and any notes on remaining issues (preferably with full sentence examples).
...
Puzzles are generated by combining the attributes with the templates, and no LLM is used in this process.
